...
public class StyleFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    private static final String viewUrl = "http://api.xuantoutiao" +
            ".com/view/v2/VNMDT28VA9/article/AODgzNDg5MzYxNjg?column_id=100010&plt=android&sid=b3ebf6ab115119241699656f4e7481f7&uid=&guid" +
